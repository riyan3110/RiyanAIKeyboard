...
""",
    ...
    private fun refreshSuggestionsSoon() {
""",
    "cheap enter key redraw",
)

start = text.index("    private fun editorSupportsNewLine(): Boolean {")
end = text.index("    private fun commit(text: String) {", start)
replacement = """    private fun standardEditorAction(info: EditorInfo? = currentInputEditorInfo): Int =
